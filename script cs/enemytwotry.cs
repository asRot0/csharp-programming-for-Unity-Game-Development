...
public class enemytwotry : MonoBehaviour
{
    Animator animator;
    ...
    public bool wenderPth = true;
    public float wenderPthspeed = 100f;
    ...
    public void Wander()
    {
        ...
        {
            float dis = Vector3.Distance(transform.position, wanderpoint);
    ...
    IEnumerator Wenderpth()
    {
        wenderPth = false;
        yield return new WaitForSeconds(wenderPthspeed);
        wenderPth = true;
    }
}
